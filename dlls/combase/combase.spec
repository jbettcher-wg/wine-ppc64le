...
@ stdcall -arch=ppc64 __wine_guest_CreateErrorInfo(ptr)
@ stdcall -arch=ppc64 __wine_guest_GetErrorInfo(long ptr)
@ stdcall -arch=ppc64 __wine_guest_SetErrorInfo(long ptr)
@ stdcall -arch=ppc64 __wine_guest_CoGetObjectContext(ptr ptr)
@ stdcall -arch=ppc64 __wine_guest_CoGetCallContext(ptr ptr)
@ stdcall -arch=ppc64 __wine_guest_CoDisconnectObject(ptr long)
@ stdcall -arch=ppc64 __wine_guest_CoLockObjectExternal(ptr long long)
@ stdcall -arch=ppc64 __wine_guest_CoIsHandlerConnected(ptr)
@ stdcall -arch=ppc64 __wine_guest_CoMarshalHresult(ptr long)
@ stdcall -arch=ppc64 __wine_guest_CoUnmarshalHresult(ptr ptr)
@ stdcall -arch=ppc64 __wine_guest_PropVariantClear(ptr)
@ stdcall -arch=ppc64 __wine_guest_PropVariantCopy(ptr ptr)
@ stdcall -arch=ppc64 __wine_guest_FreePropVariantArray(long ptr)
@ stdcall -arch=ppc64 __wine_guest_CoSetProxyBlanket(ptr long long ptr long long ptr long)
